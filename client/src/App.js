...
function App() {
	const theme = extendTheme({
		styles: {
			global: (props) => ({
				body: {
					bg: props.colorMode === 'light' ? '#F7FAFC' : '#1A202C', // Светлый и темный фон
					color: props.colorMode === 'light' ? 'black' : 'white', // Цвет текста
				},
				a: {
					color: props.colorMode === 'light' ? 'blue.500' : 'cyan.400', // Цвет ссылок
				},
			}),
		},
	});
