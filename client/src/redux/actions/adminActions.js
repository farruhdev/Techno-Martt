...
export const updateProduct =
	(brand, name, category, stock, price, id, productIsNew, description, subtitle, stripeId, images, hasDiscount, discountPercentage) =>
		async (dispatch, getState) => {
			...
			// Передаем массив изображений в productData
			const productData = {
				brand,
				name,
				category,
			...
			try {
				const { data } = await axios.put('/api/products', productData, config);
